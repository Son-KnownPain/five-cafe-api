...
<t:admin_layout>
    <jsp:attribute name="title">
        Employee timekeepings management
    </jsp:attribute>
    <jsp:attribute name="styles">

    </jsp:attribute>
    <jsp:attribute name="scripts">
        <script src="${pageContext.request.contextPath}/resources/js/pages/etk.js"></script>
    </jsp:attribute>
    <jsp:body>
        <!-- Create Modal -->
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            Create new employee timekeeping
                        </h3>
                    ...
                    <form id="create-form" class="p-4 md:p-5">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2 form-gr">
                                <label for="employeeID" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Employee</label>
                            ...
                            <div class="col-span-2 form-gr">
                                <label for="shiftID" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Shift</label>
                                <select id="shiftID" name="shiftID" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <!-- Rendered by JS -->
                                  </select>
                                <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                            </div>
                    ...
                    <form id="update-form" class="p-4 md:p-5">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="hidden col-span-2 form-gr">
                                <label for="timeKeepingIDEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">TimeKeeping ID</label>
                                <input type="text" name="timeKeepingIDEdit" id="timeKeepingIDEdit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" >
                                <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                            </div>
                            <div class="col-span-2 form-gr">
                                <label for="employeeIDEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Employee</label>
                                <select id="employeeIDEdit" name="employeeIDEdit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <!-- Rendered by JS -->
                                  </select>
                                <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                            </div>    
                            <div class="col-span-2 form-gr">
                                <label for="shiftIDEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Shift</label>
                                <select id="shiftIDEdit" name="shiftIDEdit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <!-- Rendered by JS -->
                                  </select>
                                <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                            </div>    
        ...
        <!-- Employee timekeeping Detail Modal -->
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                            View employee timekeeping detail
                        </h3>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="font-medium dark:text-white">
                                <div class="text-sm text-gray-500 dark:text-gray-400 mt-2">
                                    <span>Employee :</span>
                                    <span id="detail-employeeID"></span>
                                </div>     
                                <div class="text-sm text-gray-500 dark:text-gray-400 mt-2">
                                    <span>Shift:</span>
                                    <span id="detail-shiftID"></span>
                                </div> 
                                <div class="text-sm text-gray-500 dark:text-gray-400 mt-2">
                                    <span>Date:</span>
        ...
        <div class="mb-4">
            <h1 class="font-semibold text-3xl text-gray-800">Employees timekeepings management</h1>
            <p class="font-normala text-gray-500 text-base mt-3">The "Software Employees timekeeping management System" is a robust software solution meticulously crafted to streamline and automate the intricacies of employee-related processes within an organization. This comprehensive platform offers a suite of features designed to enhance HR efficiency, foster employee engagement, and provide valuable insights through data-driven analytics.</p>
        </div>
        <!-- Alerts -->
            <!-- Success alert -->
        ...
        <!-- Actions -->
        <div>
            <button data-modal-target="create-modal" data-modal-toggle="create-modal" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Create employee timekeeping</button>
