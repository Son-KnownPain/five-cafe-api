...
<t:admin_layout>
    ...
    <jsp:attribute name="scripts">
        <script src="${pageContext.request.contextPath}/resources/js/pages/import.js"></script>
    </jsp:attribute>
    <jsp:body>
        <!-- Create Modal -->
        <div id="create-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form id="choose-material-form" class="p-4 md:p-5">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2 form-gr">
                                <label for="materialID" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Material</label>
                                <select id="materialID" name="materialID" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <!-- Rendered by JS -->
                                  </select>
                                <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                            </div>
                            <div class="col-span-2 form-gr">
                                <label for="supplierID" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Supplier</label>
                    ...
                    <!-- Materials box -->
                    <h1 class="text-base mx-4 mt-4 font-semibold dark:text-white text-white">Materials</h1>
                    <div id="materialsBox" class="p-4 md:p-5 border-t border-solid border-gray-500">
                        <!-- RenderByJS -->
                    </div>
                    <!-- Import form -->
                    <form id="create-import-form" class="p-4 md:p-5 border-t border-solid border-gray-500">
                        <div class="flex justify-end items-center">
                            <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <svg class="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path></svg>
                                Add new import
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this imports?</h3>
        ...
        <!-- Import Detail Modal -->
        <div id="import-detail-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <!-- Modal header -->
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button id="close-import-detail-modal-btn" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="import-detail-modal">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                            <span class="sr-only">Close modal</span>
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <div id="import-info" class="mb-4">
                            <!-- RenderByJS -->
                        </div> 
                        <div id="add-mat-item-btn-box" class="">
                            <button id="add-mat-item-btn" type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        ...
                        <div id="detail-add-form" class="hidden py-4 border-y border-solid border-gray-200">
                            <h1 class="text-xs font-semibold dark:text-gray-400 text-gray-700 mb-3 uppercase">ADD MATERIAL</h1>
                            <form id="add-material-form">
                                <input type="hidden" id="importIDAdd" name="importID">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2 form-gr">
                                        <label for="materialIDAdd" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Material</label>
                                        <select id="materialIDAdd" name="materialID" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <!-- Rendered by JS -->
                                          </select>
                                        <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                                    </div>
                                    <div class="col-span-2 form-gr">
                                        <label for="supplierIDAdd" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Supplier</label>
                                        <select id="supplierIDAdd" name="supplierID" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <!-- Rendered by JS -->
                                          </select>
                                        <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                                    </div>
                                    <div class="col-span-2 form-gr">
                                        <label for="unitPriceAdd" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unit price</label>
                                        <input type="number" id="unitPriceAdd" name="unitPrice" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="15000">
                                        <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                                    </div>
                                    <div class="col-span-2 form-gr">
                                ...
                                <div class="flex justify-end items-center">
                                    <button id="cancel-add-mat-btn" type="button" class="py-2.5 px-5 mr-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                        Cancel
                                    </button>
                                    <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        <i class="fa-solid fa-plus mr-3"></i>
                        ...
                        <div id="detail-update-form" class="hidden py-4 border-y border-solid border-gray-200">
                            <h1 class="text-xs font-semibold dark:text-gray-400 text-gray-700 mb-3 uppercase">EDIT MATERIAL</h1>
                            <form id="update-material-form">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="form-gr">
                                        <input type="hidden" name="importID" id="importIDEdit">
                                        <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                                    </div>
                                    <div class="form-gr">
                                        <input type="hidden" name="materialID" id="materialIDEdit">
                                        <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                                    </div>
                                    <div class="col-span-2 form-gr">
                                        <label for="supplierIDEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Supplier</label>
                                        <select id="supplierIDEdit" name="supplierID" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <!-- Rendered by JS -->
                                        </select>
                                        <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                                    </div>
                                    <div class="col-span-2 form-gr">
                                        <label for="unitPriceEdit" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unit price</label>
                                ...
                                <div class="flex justify-end items-center">
                                    <button id="cancel-update-mat-btn" type="button" class="py-2.5 px-5 mr-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                        Cancel
                                    </button>
        ...
        <div class="mb-4">
            <h1 class="font-semibold text-3xl text-gray-800">Imports management</h1>
            <p class="font-normala text-gray-500 text-base mt-3">The Import Management feature provides a comprehensive solution for handling the importation of goods into the system. It facilitates the efficient tracking and organization of import details, ensuring accurate and streamlined management of incoming inventory.</p>
        </div>
        <!-- Material quantityInStock below 5 -->
        <div class="mt-5 mb-5 bg-slate-100 rounded-md p-4" id="product-out-quantityinstock-box">
            <h1 class="text-sm font-semibold text-gray-500">The product has very little inventory</h1>
            <div class="grid grid-cols-1 gap-4" id="product-out-quantityinstock-content"></div>
        </div>
        <!-- Alerts -->
            <!-- Success alert -->
        ...
        <!-- Actions -->
        <div>
            <button id="create-btn" data-modal-target="create-modal" data-modal-toggle="create-modal" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Create import</button>
            <button data-modal-target="import-detail-modal" data-modal-toggle="import-detail-modal" class="hidden">Detail</button>
