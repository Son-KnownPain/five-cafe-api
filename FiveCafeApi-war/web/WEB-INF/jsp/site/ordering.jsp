...
<t:admin_layout>
    ...
    <jsp:body>
        ...
        <div class="mb-4">
            <h1 class="font-semibold text-3xl text-gray-800">Ordering</h1>
        </div>
        <!-- Alerts -->
            <!-- Success alert -->
                ...
                <div class="p-4 bg-slate-100 rounded-md">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2 form-gr">
                            <label for="billStatusID" class="block mb-2 text-sm font-medium text-gray-500">Choose bill status</label>
