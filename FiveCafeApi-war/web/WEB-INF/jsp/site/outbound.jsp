...
<t:admin_layout>
    ...
    <jsp:attribute name="scripts">
        <script src="${pageContext.request.contextPath}/resources/js/pages/outbound.js"></script>
    </jsp:attribute>
    <jsp:body>
        <!-- Create Modal -->
        <div id="create-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- outbound form -->
                    <form id="create-outbound-form" class="p-4 md:p-5 border-t border-solid border-gray-500">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2 form-gr">
        ...
        <div id="outbound-detail-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <!-- Modal header -->
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                            View Outbound Detail
                        </h3>
                        <button id="close-outbound-detail-modal-btn" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="outbound-detail-modal">
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                            <span class="sr-only">Close modal</span>
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <div id="outbound-info" class="mb-4">
                            <!-- RenderByJS -->
                        </div>
                        ...
                        <div id="detail-add-form" class="hidden py-4 border-y border-solid border-gray-200">
                            ...
                            <form id="add-material-form">
                                <input type="hidden" id="outboundIDAdd" name="outboundID">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2 form-gr">
                        ...
                        <div id="detail-update-form" class="hidden py-4 border-y border-solid border-gray-200">
                            ...
                            <form id="update-material-form">
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="form-gr">
                                        <input type="hidden" name="outboundID" id="outboundIDEdit">
                                        <span class="text-base font-normal text-red-500 mt-1 form-message"></span>
                                    </div>
                                    <div class="form-gr">
        ...
        <!-- Actions -->
        <div>
            <button data-modal-target="create-modal" data-modal-toggle="create-modal" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Create outbound</button>
            <button data-modal-target="outbound-detail-modal" data-modal-toggle="outbound-detail-modal" class="hidden">Detail</button>
        ...
        <form class="mb-2" id="search-form">
            <div class="flex">
                ...
                <div class="relative w-full">
                    <input type="search" name="dateForm" id="dateForm" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Enter date form">
                    To
                    <input type="search" name="dateTo" id="dateTo" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Enter date to">
